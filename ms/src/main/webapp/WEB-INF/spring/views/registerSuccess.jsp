...
<title>Registration successful - Multi Search page</title>
    						...
    						<li class="active">
			    				<div class="top-grids">
					      			...
					      			<div class="top-grid2">
						      			...
						      			<p><h5>Your registration is successful. Please <a href="login">Click here</a> to login again</h5></p>
					      			</div>
...
<ul>
	<li class="active">
		<div class="top-grids">
			<div class="top-grid2">User registration is successful. Please <a class="user active" href="login">login</a> again</div></div></li></ul>
