...
<title>Registration Failure - Multi Search page</title>
...
<script type="text/javascript" src="resources/js/JFCore.js"></script>
		...
		<!-- Set here the key for your domain in order to hide the watermark on the web server  dislike.png -->
		...
		<div class="tab style-1">
    					...
    					<ul>
    						<li class="active">
			    				<div class="top-grids">
					      			<div class="top-grid1">
					      				<img src="resources/images/dislike.png" title="" alt="">
					      			</div>
					      			<div class="top-grid2">
						      			<!-- <a href="#single.html"><h4>Saketh<h4></h4></a> -->
						      			<p><h5>Your registration is unsuccessful. Please <a href="register">register</a> again.</h5></p>
					      			</div>
